...
sudo cp /vagrant/mail_1/work/postfix/main.cf /etc/postfix/main.cf
...
cp /vagrant/mail_1/work/dovecot/dovecot.conf /etc/dovecot/dovecot.conf

#10-mail.conf
mv /etc/dovecot/conf.d/10-mail.conf /etc/dovecot/conf.d/10-mail.conf.org
cp /vagrant/mail_1/work/dovecot/10-mail.conf /etc/dovecot/conf.d/10-mail.conf

#10-auth.conf
mv /etc/dovecot/conf.d/10-auth.conf /etc/dovecot/conf.d/10-auth.conf.org
cp /vagrant/mail_1/work/dovecot/10-auth.conf /etc/dovecot/conf.d/10-auth.conf

#10-ssl.conf
mv /etc/dovecot/conf.d/10-ssl.conf /etc/dovecot/conf.d/10-ssl.conf.org
cp /vagrant/mail_1/work/dovecot/10-ssl.conf /etc/dovecot/conf.d/10-ssl.conf
